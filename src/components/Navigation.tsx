      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between items-center py-4">
          ...
          <Link to="/" className="flex items-center space-x-3">
            ...
            <span className="text-xl font-bold text-gray-900">AI Repository</span>
          </Link>
            ...
            <div className="space-y-2">
              ...
              {currentUser && (
                <button
                  ...
                  className="flex items-center space-x-2 px-3 py-2 rounded-lg font-medium text-red-600 hover:bg-red-50 w-full text-left"
                >
                  <LogOut className="w-4 h-4" />
                  <span>Logout</span>
                </button>
